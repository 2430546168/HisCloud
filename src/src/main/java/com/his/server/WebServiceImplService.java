 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://server.his.com/", wsdlLocation = "http://192.168.1.195:8090/Web/Web?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.1.195:8090/Web/Web?wsdl");
