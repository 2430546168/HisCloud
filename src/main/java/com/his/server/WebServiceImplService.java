 ...
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://server.his.com/", wsdlLocation = "http://192.168.1.195:8099/Web/Web?wsdl")
public class WebServiceImplService
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://server.his.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.195:8099/Web/Web?wsdl");
    ...
    /**
     * @return returns WebServices
     */
    @WebEndpoint(name = "WebServiceImplPort")
    public WebServices getWebServiceImplPort() {
        return super.getPort(new QName("http://server.his.com/", "WebServiceImplPort"), WebServices.class);
    }
     ...
     */
    @WebEndpoint(name = "WebServiceImplPort")
    public WebServices getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.his.com/", "WebServiceImplPort"), WebServices.class, features);
    }
