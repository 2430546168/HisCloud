...
import com.yhhis.common.wxSDK.pojo.Token;
...
public class BaseComponent extends AbstractComponent {
    ...
    public Token token() throws WeixinException {
        ...
        if (StringUtils.isEmpty(wxConfig.getAppSecret())) {
            throw new IllegalArgumentException("secret can't be null or empty");
        }
        //拼接参数
        String param = "?grant_type=client_credential&appid=" + wxConfig.getAppID() + "&secret=" + wxConfig.getAppSecret();
        //创建请求对象
