...
public class QRCodeUtil {
    ...
    public static String getQRCode(String depCode, String depname, String docName, String docCode) {
        ...
        querys.put("content", "http://www.yhtcs.cn/#/appointment?depCode=" + depCode + "&depname=" + depname + "&docName=" + docName + "&docCode=" + docCode);
